...
function validateForm(formData) {
  ...
  const requiredFields = ['nome', 'telefone', 'email', 'propriedade', 'cidade', 'estado', 'area', 'cultura', 'energia'];
...
contactForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    showErrorMessage(['Ocorreu um erro ao enviar o formulário. Tente novamente em alguns minutos.']);
  } finally {
